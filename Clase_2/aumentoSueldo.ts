...
let sueldoEmpleado: number = rls.questionFloat("Ingrese sueldo del empleado:");
    if (sueldoEmpleado <= 15000) {
let aumento : number = sueldoEmpleado *0.2 
console.log("Si su sueldo es es menor a $15000 tendra un aumento del 20% y sera de:" , aumento)
} else 
    if (sueldoEmpleado >= 15001  && sueldoEmpleado <= 20000){
    let aumento : number = sueldoEmpleado + sueldoEmpleado *0.1 
    console.log("Si su sueldo es de entre $15001 y $20000 tendra un aumento del 10% y sera de:" , aumento)
    } else 
    if (sueldoEmpleado >= 20001 && sueldoEmpleado <= 25000 ){
        let aumento : number = sueldoEmpleado + sueldoEmpleado *0.05
